...
module.exports.superUser = async function(req,res){
  ...
  try {
    ...
    await User.create({
      userType:"admin",
      name:"tushar",
      email:"tushargupta24042002@gmail.com",
      password:"Tushar@2002",
      confirmPassword:"Tushar@2002",
      department:"HR"
    })
    return res.end(`<h3>user credentials</h3> <p>email:  tushargupta24042002@gmail.com <br> paasword : Tushar@2002</p> <h2>please delete wizzeanlum as soon as you create new user</h2> </h2> `)
  } catch (error) {
    console.log(error);
